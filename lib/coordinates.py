...
sets = [
    (left_right_horizontal, "right"),
    (right_left_horizontal, "left"),
    (up_down_vertical, "down"),
    (down_up_vertical, "up"),
    (diagonal_45_left_right, "45_right"),
    (diagonal_45_right_left, "45_left"),
    (diagonal_315_left_right, "315_right"),
    (diagonal_315_right_left, "315_left"),
]
